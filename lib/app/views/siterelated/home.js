...
kopal.page = kopal.page || {}

kopal.page.todo_status_change_event = function(element_id, url)
{
	s = kopal.spinner(element_id, 'Bottom', 'Saving changes');
	new Ajax.Request(url, {asynchronous:true, evalScripts:true, onComplete:function() { Element.hide(s); } });
}